...
```{r echo=FALSE, eval=TRUE, warning=FALSE}
datatable(data.frame(item = c("fox", "cheese", "sheep", "banana", "chair", "pea", "heart", "pumpkin", "cucumber", "hippo", "fzx", "cheesx", "shxxp", "banxna", "chxir", "pxa", "hexrt", "pumpkxn", "cxcumber", "hxppo"),
...
![](images/lexical_decision_stimuli_excel.gif)

Alternatively, you can download the file:

`r fa("download")`[lexical_decision_stimuli.csv](https://github.com/jamesbrandscience/jspsych-tutorial/raw/main/lexical_decision_stimuli.csv).
...
`r fa("download")` [here](lexical_decision_stimuli_JSON.js), in case you had problems with running the R code.
